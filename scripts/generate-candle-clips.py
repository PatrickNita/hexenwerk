"""Bake candle clip alpha × luminance mask into single glow mask PNGs for iOS WebKit."""
...
CANDLE_FRAMES = (2, 3, 4)
LUMINANCE_MASK = ASSETS / "candles-mask.png"
...
def main() -> None:
    ...
    for frame in CANDLE_FRAMES:
        clip_path = ASSETS / f"candles-clip{frame}.png"
        output_path = ASSETS / f"candles-glow{frame}.png"
